...
module.exports = class XlJson {
    ...
    getZipFile(zip, kendo) {
        var kendo = kendo;
        console.log(kendo);
        // create the workbook object from here and send it to the below function
        var options = {
            excel: {
        ...
        var element = {};
        options = $.extend(options, kendo.widgets[0].widget.fn.options);
        var workbook = new kendo.spreadsheet.Workbook(options);
        return kendo.spreadsheet._readWorkbook(zip, workbook);
